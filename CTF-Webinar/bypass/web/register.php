...
<head>
  <meta charset="UTF-8">
  <title>Register - CTF Bypass Admin Dashboard</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h1>Register untuk CTF Bypass Admin Dashboard</h1>
    <p>Buat akun baru untuk mengikuti tantangan CTF ini.</p>
    <?php if ($registerSuccess): ?>
      <h2>Registered successfully as <?= htmlspecialchars($_SESSION['user']) ?></h2>
